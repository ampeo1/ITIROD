...
export default class Twitt{
    ...
    public static HTMLPresentation(metadataTwitt: MetadataTwitt){
        ...
        countRetwitt.innerText = '5';
        
        retwitt.appendChild(Twitt.DisableRetwittSvg(retwitt, countRetwitt));
        ...
        countLike.innerText = '10';

        like.appendChild(Twitt.DisableLikeSvg(like, countLike));
    ...
    private static DisableRetwittSvg(div: HTMLDivElement, count: HTMLHeadingElement){
        var retwittSvg = Twitt.CreateSvg();

        retwittSvg.addEventListener('click', () => {
            div.replaceChild(Twitt.RetwittSvg(div, count), retwittSvg);
        })
    ...
    private static RetwittSvg(div: HTMLDivElement, count: HTMLHeadingElement){
        var retwittSvg = Twitt.CreateSvg();

        retwittSvg.addEventListener('click', () => {
            div.replaceChild(Twitt.DisableRetwittSvg(div, count), retwittSvg);
        })
    ...
    private static DisableLikeSvg(div: HTMLDivElement, count: HTMLHeadingElement){
        var likeSvg = Twitt.CreateSvg();

        likeSvg.addEventListener('click', () => {
            div.replaceChild(Twitt.LikeSvg(div, count), likeSvg);
        })
    ...
    private static LikeSvg(div: HTMLDivElement, count: HTMLHeadingElement){
        var likeSvg = Twitt.CreateSvg();

        likeSvg.addEventListener('click', () => {
            div.replaceChild(Twitt.DisableLikeSvg(div, count), likeSvg);
        })
